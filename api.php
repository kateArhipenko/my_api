...
require_once($_SERVER['DOCUMENT_ROOT'] . "/api/src/services/project_service.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/api/src/services/role_service.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/api/src//services/task_service.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/api/src//services/user_service.php");
